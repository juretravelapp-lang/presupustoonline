          ...
          return (
            <motion.button
              ...
              style={{
                ...
                border: isSelected ? '1.5px solid rgba(245,158,11,0.45)' : '1.5px solid rgba(255,255,255,0.08)',
                borderRadius: 14,
                cursor: 'pointer',
                textAlign: 'left',
                transition: 'all 0.18s',
                boxShadow: isSelected ? '0 2px 16px rgba(245,158,11,0.08)' : 'none',
              }}
            >
              ...
              <span style={{
                ...
                fontSize: 14,
                fontWeight: 700,
                color: isSelected ? '#FBBF24' : 'rgba(148,163,184,1)',
              }}>
                {servicio.label}
              </span>
              ...
              <AnimatePresence mode="wait">
                {isSelected ? (
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    exit={{ scale: 0 }}
                    style={{ width: 24, height: 24, borderRadius: '50%', background: '#F59E0B', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}
                  >
